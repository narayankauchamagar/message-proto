...
public final class HelloWorldServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "np.com.thapanarayan.entities.pb.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest,
      np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest.class,
      responseType = np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest,
      np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest, np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse> getHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getHelloMethod = HelloWorldServiceGrpc.getHelloMethod) == null) {
          HelloWorldServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest, np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest request,
        io.grpc.stub.StreamObserver<np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceStub
    ...
    /**
     */
    public void hello(np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest request,
        io.grpc.stub.StreamObserver<np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceBlockingStub
    ...
    /**
     */
    public np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse hello(np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse> hello(
        np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              np.com.narayan.thapa.dtos.HelloWorldProto.HelloRequest,
              np.com.narayan.thapa.dtos.HelloWorldProto.HelloResponse>(
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return np.com.narayan.thapa.dtos.HelloWorldProto.getDescriptor();
    }
